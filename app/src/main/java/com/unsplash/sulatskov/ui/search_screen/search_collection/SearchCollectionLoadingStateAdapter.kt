...
class SearchCollectionLoadingStateAdapter(
    private val adapter: PagingSearchCollectionAdapter
) : LoadStateAdapter<SearchCollectionLoadingStateAdapter.NetworkStateItemViewHolder>() {
