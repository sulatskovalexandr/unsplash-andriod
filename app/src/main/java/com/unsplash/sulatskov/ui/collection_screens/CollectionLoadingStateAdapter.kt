...
class CollectionLoadingStateAdapter(
    private val adapter: PagingCollectionAdapter
) : LoadStateAdapter<CollectionLoadingStateAdapter.NetworkStateItemViewHolder>() {
