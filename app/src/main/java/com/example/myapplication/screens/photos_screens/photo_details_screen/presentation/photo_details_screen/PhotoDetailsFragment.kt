...
//        private const val PHOTO_PROFILE_KEY = "PHOTO_PROFILE_KEY"
//        private const val USER_NAME_KEY = "USER_NAME_KEY"

//        private fun createArgs(photoId: String, photoUrl: String, photoProfile: String, userName: String) =
//            Bundle(4).apply {
//                putString(PHOTO_ID_KEY, photoId)
//                putString(PHOTO_URL_KEY, photoUrl)
//                putString(PHOTO_PROFILE_KEY, photoProfile)
//                putString(USER_NAME_KEY, userName)
//            }
//
//        fun create(photoId: String, photoUrl: String, photoProfile: String, userName: String) =
//            PhotoDetailsFragment().apply {
//                arguments = createArgs(photoId, photoUrl, photoProfile, userName)
//            }
//    }
